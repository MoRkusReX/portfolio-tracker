  ...
  PT.UI = {
    ...
    init: function () {
      this.el = {
        ...
        indicatorExplorerFundamentalsTitle: qs('indicatorExplorerFundamentalsTitle'),
        indicatorExplorerFundamentalsAssetLabel: qs('indicatorExplorerFundamentalsAssetLabel'),
        indicatorExplorerFundamentalsOverallPill: qs('indicatorExplorerFundamentalsOverallPill'),
        indicatorExplorerFundamentalsMeta: qs('indicatorExplorerFundamentalsMeta'),
        indicatorExplorerFundamentalsSummary: qs('indicatorExplorerFundamentalsSummary'),
        indicatorExplorerFundamentalsGrid: qs('indicatorExplorerFundamentalsGrid'),
        indicatorExplorerFundamentalsReasons: qs('indicatorExplorerFundamentalsReasons'),
    ...
    renderIndicatorsPanel: function (config) {
      ...
      function tradePlanBlock(tf) {
        ...
        return '<div class="indicator-tech indicator-tech--tradeplan">' +
          '<div class="indicator-tech__head">' +
            '<div class="indicator-tech__title-wrap"><div class="indicator-tech__title" tabindex="0" data-help-tooltip="' + esc(indicatorHelpText('Long Trade Plan')) + '" aria-label="Long trade plan explanation">Long Trade Plan</div></div>' +
          ...
          '<div class="indicator-tech__metrics indicator-tech__metrics--3">' +
            ...
            '<div class="indicator-sr__metric indicator-tech__metric"><span>Setup Quality</span><strong>' + esc(confidenceText) + '</strong></div>' +
            '<div class="indicator-sr__metric indicator-tech__metric"><span>RR</span><strong>' + esc(rrText) + '</strong></div>' +
          '</div>' +
          '<div class="indicator-tech__note">' + esc(confidenceNote) + '</div>' +
      ...
      function shortTradePlanBlock(tf) {
        ...
        return '<div class="indicator-tech indicator-tech--tradeplan indicator-tech--shortplan">' +
          '<div class="indicator-tech__head">' +
            '<div class="indicator-tech__title-wrap"><div class="indicator-tech__title" tabindex="0" data-help-tooltip="' + esc(indicatorHelpText('Short Trade Plan')) + '" aria-label="Short trade plan explanation">Short Trade Plan</div></div>' +
            '<span class="' + tradeConfidencePillClass(confidence) + '">' + esc(confidence) + '</span>' +
          '</div>' +
          '<div class="indicator-tech__metrics indicator-tech__metrics--3">' +
            '<div class="indicator-sr__metric indicator-tech__metric"><span>Short Entry</span><strong>' + esc(entryZone) + '</strong></div>' +
            '<div class="indicator-sr__metric indicator-tech__metric"><span>Cover / Take Profit</span><strong>' + esc(coverZone) + '</strong></div>' +
            '<div class="indicator-sr__metric indicator-tech__metric"><span>Failure Exit</span><strong>' + esc(failureExitZone) + '</strong></div>' +
          '</div>' +
          '<div class="indicator-tech__metrics indicator-tech__metrics--3">' +
            '<div class="indicator-sr__metric indicator-tech__metric"><span>Entry Type</span><strong>' + esc(entryType) + '</strong></div>' +
          ...
          '<div class="indicator-tech__note">' + esc(confidenceNote) + '</div>' +
          '<div class="indicator-tech__note indicator-trade-plan__reasons">' + esc(planReason) + '</div>' +
          '<div class="indicator-tech__note indicator-trade-plan__disclaimer">' + esc(String(plan.note || 'Estimated short entry/cover/failure zones are derived from technical indicator confluence and are not guaranteed.')) + '</div>' +
        '</div>';
      }
